...
%>
                                    ...
                                    success: function(response) {
                                        ...
                                        if (list.length == 0) { //검색 결과가 없을 때
                                            ...
                                            for (var i in list) { //결과 반환
                                                ...
                                                if (userImage == null) {
                                                    $(".idSearchList").append("<div class=oneProfile>" +
                                    ...
                                    success: function(response) {
                                        ...
                                        if (list.length == 0) { // 검색결과가 없을때
                                            ...
                                            for (var i in list) { //결과 반환
                                                ...
                                                if (userImage == null) {
                                                    $(".nameSearchList").append("<div class=oneProfile>" +
                                                        "<div class=profileImage>" +
                                        ...
                                        if (list.length == 0) { //검색 결과가 없을 때
                                            ...
                                            if (hashtagArr.length == 0) { //위 조건과 맞는 결과가 없을 때
                                                ...
                                                for (var i in hashtagArr) { //결과 반환
                                                    $(".hashtagSearchList").append("<p><a class=hashtagList href='hashtagresult?hashtag=" + hashtagArr[i] + "'>" + "#" + hashtagArr[i] + "</a></p>");
                                                } // for end
                                            } // else end
                                        } // else
                                    }, // success end
                                        ...
                                        if (list.length == 0) { //검색 결과가 없을 때
                                            ...
                                            if (hashtagArr.length == 0) { //위 조건과 맞는 결과가 없을 때
                                                ...
                                                for (let i of hashtagSet) { //결과 반환
                                                    $(".hashtagSearchList").append("<p><a class=hashtagList href='hashtagresult?hashtag=" + i + "'>" + "#" + i + "</a></p>");
	...
	<ul class=navbarLinks>
		...
		<svg class="loginIcon" viewBox="2 2 20 20" onclick="location.href='/profile?id=<%=id%>'">
            ...
            <div class="search container">
                <button id="idbutton" class="search_button">아이디</button>
                <button id="namebutton" class="search_button">이름</button>
                <button id="hashtagbutton" class="search_button">해시태그</button><br>
            </div>
